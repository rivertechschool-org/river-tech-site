/* River Tech — Full-Time Enrollment 2026-27 form logic
   ...
   Apps Script backend. This ASSISTED variant carries no enrollment fee:
   it declares feeWaived, so no Stripe session is created.
    ...
    Promise.all(fileTasks)
      .then(function (files) {
        ...
        return fetch(BACKEND_URL, {
          ...
          .then(function (data) {
            if (data && data.ok) {
              window.location.href = "register-school-2026-27-assisted-success.html";
            } else {
